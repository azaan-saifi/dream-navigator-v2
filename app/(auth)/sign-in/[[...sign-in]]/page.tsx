...
export default function SignInPage() {
  return (
    <main className="flex h-screen items-center justify-center max-sm:-mt-14">
            ...
            {(isGlobalLoading) => (
              <>
                <SignIn.Step name="start">
                  <Card className="w-full border border-zinc-700 bg-dark-200 text-white sm:w-96">
                    <CardHeader>
                    ...
                    <CardContent className="grid gap-y-4">
                      ...
                      <Clerk.Field name="identifier" className="space-y-2">
                        ...
                        <Clerk.Input type="email" required asChild>
                          <Input className="rounded-[7px] border-zinc-600" />
                        </Clerk.Input>
                    ...
                    <CardFooter>
                      <div className="grid w-full gap-y-4">
                        <SignIn.Action submit asChild>
                          <Button
                            disabled={isGlobalLoading}
                            className="rounded-[7px] bg-primary-100 hover:bg-[#f81d42]"
                          >
                            <Clerk.Loading>
                              {(isLoading) => {
                                return isLoading ? (
                ...
                <SignIn.Step name="choose-strategy">
                  <Card className="w-full border border-zinc-700 bg-dark-200 sm:w-96">
                    <CardHeader>
                ...
                <SignIn.Step name="verifications">
                  <SignIn.Strategy name="password">
                    <Card className="w-full border-zinc-700 bg-dark-200 sm:w-96">
                      <CardHeader>
                      ...
                      <CardFooter>
                        <div className="grid w-full gap-y-4">
                          <SignIn.Action submit asChild>
                            <Button
                              disabled={isGlobalLoading}
                              className="rounded-[7px] bg-primary-100 hover:bg-primary-50"
                            >
                              <Clerk.Loading>
                                {(isLoading) => {
                                  return isLoading ? (
